            ...
            <div class="vertical-block__content vertical-header__content">
                <div class="vertical-header__text in-view">
                    <div class="vertical-header__logo">
                        <svg viewBox="0 0 1000 215" zwidth="136" height="24" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                ...
                                <g>
                                    <g>
                                        ...
                                        <path fill="#0086CC" d="M826.34,70.88c-4.83,0-8.74,2.12-8.74,6.94v115.72c0,4.82,3.91,6.32,8.74,6.32c4.83,0,8.74-1.5,8.74-6.32
                                            V77.82C835.09,73,831.17,70.88,826.34,70.88z"/>
                    ...
                    <div class="vertical-header__buttons btn-block in-view"> 
                        <div class="ecwid-button">
                            ...
                            <button class="create-store-success btn btn-large btn-success btn-icon">
                                ...
                                Store is created            </button>

                            <div class="create-store-loading-note ecwid-button-description">
                                Creating store            </div>

                            <div class="create-store-success-note ecwid-button-description">
                                Preparing your store dashboard            </div>

                            <div class="button-description-mobile">
                                Free registration, No credit card required            </div>
                            <div class="create-store-have-account ecwid-button-description">
                                <span class="create-store-have-account-question">Already have Ecwid account?</span>
                                <a class="create-store-have-account-link" href="admin-post.php?action=ec_connect">Connect your store to this site</a>
                            </div>
                            <div class="button-description-mobile">
                                You will be asked to log in to your Ecwid Control Panel<br>and give permissions to show your store on this site            </div>
                            <div class="button-description-mobile">
                                <h3>Get ready to sell online</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="vertical-block__container vertical-text__container">
            <div class="vertical-block__content vertical-text__content">
                ...
                <div class="vertical-text__descr">
                    ...
                    <div class="ecwid-button">
                        <div style="position: absolute; left: -10000px" id="preloader-for-check-icon">
                            <button  style="display: block" class="create-store-success btn btn-large btn-success btn-icon">
                                <i class="icon-check"></i>
                                Store is created            </button>
                        </div>
